  ...
  <sign-template>
    ...
    <template #form>
      ...
      <div mt-10 w="100%" flex justify-between items-center>
        ...
        >
          <span font-600>{{ t('pages.signin.account') }}</span>
        </el-button>
        <el-button
          w="46%"
          size="large"
        ...
        >
          <span font-600> {{ t('pages.signin.phone') }}</span>
        </el-button>
        <el-button
          w="46%"
          size="large"
        ...
        >
          ...
          <span font-600> {{ t('pages.signin.wechat') }}</span>
        </el-button>
      </div>
    </template>
    <template
      ...
      v-if="loginType === 'account' || loginType === 'phone'"
    >
      <terms-conditions :label="t('pages.signin.btn')"></terms-conditions>
    </template>
  </sign-template>
</template>
